...
def perimetro_triangulo(lado1, lado2, lado3): #solicita tres parametros lado1, lado2 y lado3
    """Funcion para calcular el perimetro de un triangulo, recibe los tres lados del triangulo y retorna el perimetro calculado"""
    return lado1 + lado2 + lado3 #retorna el resultado de calcular el perimetro del triangulo sumando los tres lados